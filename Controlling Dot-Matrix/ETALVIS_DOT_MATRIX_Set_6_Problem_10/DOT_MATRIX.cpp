...
void Entering_SIMULTANEOUS_ALL_Direction_Display_1234_Collide()
{
         ...
         for (int j = 0; j < 8; j++)
         {
            ...
            else
            {
               Send_Data(j+1,(Display_2[j] << i)|(Display_3[j] >> right_shift),
                      ...
                      j+1,(Display_4[j] << i) | ((Display_2[j] >> i)|(Display_1[j] << right_shift)),
                      j+1,(Display_3[j] >> i)|(Display_2[j] << right_shift));
            }
         }
      index = temp;
      if (i == 3)
   ...
   for (int i = 7; i >= 0; i--)
   {
      ...
      Send_Data(j+1,((Display_1[j] << i)|(Display_2[j] >> right_shift)) | (Display_1[j] >> i)|Display_1[index],
            ...
            {
               Send_Data(j+1,((Display_1[j] << i)|(Display_2[j] >> right_shift)) | (Display_1[j] >> i),
                j+1,(Display_2[j] << i | (Display_3[j] >> right_shift))|((Display_1[j] << right_shift))|((Display_2[j] >> i)),
                j+1,(Display_3[j] << i | (Display_4[j] >> right_shift))|((Display_2[j] << right_shift))|((Display_3[j] >> i)),
                j+1,((Display_4[j] << i))|((Display_3[j] << right_shift))|((Display_4[j] >> i)));
            }
         }
      index = temp;
      if (i == 3 || i == 7)
